Build a simple React app that displays a table view of the products in "products.json". The table should be sortable by column, 
and include a search bar that filters the table elements on every key stroke.
